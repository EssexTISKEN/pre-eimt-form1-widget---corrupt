(async () => {
    ...
    /* ============================================================
       2. ACCORDÉONS — VERSION PROFESSIONNELLE
    ============================================================ */
    ...
    /* ============================================================
       3. CAPTURE DES ÉLÉMENTS DU FORMULAIRE
    ============================================================ */
    ...
    function rebuildRows(prefill = []) {
        ...
        for (let i = 0; i < n; i++) {
            ...
            r.innerHTML = `
                ...
                <td><input class="r_sal" type="number" step="0.01" min="0" /></td>
            `;
    ...
    /* ============================================================
       5. MATTER — RÉCUPÉRATION DU CONTEXTE
    ============================================================ */
    ...
    /* ============================================================
       6. PRÉREMPLISSAGE SI UN MATTER EST DISPONIBLE
    ============================================================ */
    ...
    $("btn_submit").onclick = async () => {
        ...
        if (tous.value === "Non") {
            ...
            payload["Salaire_horaire_unique"] =
                dec2($("Salaire_horaire_unique").value);
        }
